...
function init() {
    ...
    sound.position.z = 0;
    sound.playSound();  
     pucePool.createPuce("classic_or_rond1",
                classic_puce,   
                    attache_or,
    "texture_or_petit_rond" ,
    true, true, true ,0.05);
	
	pucePool.createPuce("classic_or_rond2", classic_puce,   
                    attache_or,
    "texture_or_petit_rond" ,
    true, true, true ,0.05);
	
	pucePool.setPosition("classic_or_rond2",1,2,1);
...
function createTree(tree,x,z){
	...
	treeCloned.position.y = -1;
    treeCloned.rotation.x = -Math.PI/2;

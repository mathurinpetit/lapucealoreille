...
var PUCES = function(scene){ 
    ...
    this.update = function(renderer){
     ...
     this.setPosition = function(id, x,y,z){
        this.objects[id].puce.position.x = this.objects[id].attache.position.x = this.objects[id].wrapAttache.position.x = x;
        this.objects[id].puce.position.y = y;
        this.objects[id].attache.position.y = y+0.54;
        this.objects[id].puce.position.z = this.objects[id].attache.position.z = this.objects[id].wrapAttache.position.z = z;
     }
}  
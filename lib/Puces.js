...
var PUCES = function(scene){ 
    ...
    this.createPuce = function(id, model, attacheModel, modelTexture, shadow, reflexivity, pickable, vitesseRotation) { 
        ...
        var texture = renderer._microCache.getSet(modelTexture, THREE.ImageUtils.loadTexture('./textures/'+modelTexture+'.jpg'));
        ...
        if(this.objects[id].reflexivity){
            ...
            modelCloned.children[0].children[0].children[0].children[13].material = faceMaterial;
        }        

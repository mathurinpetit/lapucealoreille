...
var PUCES = function(scene){ 
    ...
    this.move = function(id, x, y, z){
        ...
        this.objects[id].attache.position.y += y;
    ...
    this.update = function(renderer){
            ...
            this.objects[obj3d].wrapPuce.rotation.y += this.objects[obj3d].vitesseRotation;
           // this.objects[obj3d].attache.rotation.y += this.objects[obj3d].vitesseRotation;
           // this.objects[obj3d].wrapAttache.rotation.y += this.objects[obj3d].vitesseRotation;
        }
    }

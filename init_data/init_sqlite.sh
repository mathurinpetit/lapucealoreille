...
sqlite3 lapucealoreille.db "insert into models VALUES (4,
                            ...
                            'texture_argent_papillon_plein',
                            'Modèle : Classic Argent Papillon \Type de puce : Classics Argent Papillon (I) \Attaches : Argentées ',
                '            Cette paire est constituée d''une puce Classics Argent Papillon I plus large et plus robuste dont le centre en silicum vert donne un aspect rerto des plus intéressant. Comme toute paire de la collection des Classics cette boucle d''oreille élégante est entièrement fabriquée à la main avec des puces de récupération. L''originalité de ce bijoux écologiquement geek vous fera briller en soirée.',
...
sqlite3 lapucealoreille.db "insert into models VALUES (5,
                            ...
                            'Modèle : Classic Or Papillon Carré \Type de puce : Classics Or Papillon Carré \Attaches : Dorées ',
                '            Cette paire est constituée d''une puce Classic Or Papillon Carré dont le format est quasiment carré. De petite taille (1.4 x 1.4 cm), elle porte une attache simple dorée et fait partie de la collection des Classics. C''est un modèle de puce plus rare représentant une sorte de papillon doré en son centre. Cette boucle d''oreille élégante et simple reste très originale, de plus, elle est entièrement faite à la main. Au vu de la pauvreté de ce type de puce en France, elle est une des créations les plus demandé sur La Pusse à l''Oreille.',
...
sqlite3 lapucealoreille.db "insert into models VALUES (6,
                            ...
                            'Modèle : Classic Argent Papillon(II) \Type de puce : Classics Argent Papillon(II) \Attaches : Argentées ',
                '            Contrairement à la puce Classic Argent Papillon(I), ce modèle est à la fois plus petit, et plus sophistiqué. Constitué d''une puce Classics ""Argent Papillon(II)"" en plastique blanc, la paire paraît presque transparente à la lumière du jour. De base elle possède une attache simple argentée, mais il est possible de la commander avec une attache de couleur ou d''un autre type sur simple demande téléphonique. La petite carrure de ce modèle en fait un bijoux raffiné et discret qui sait ce faire oublié.',
                'classic_argent_papillon2_0.jpg',
                'classic_argent_papillon2_1.jpg',
                'classic_argent_papillon2_2.jpg',
                'classic_argent_papillon2_3.jpg',3, 'TWTV4JDHM6X2L', 7.5);";
